...
func (x DiscoveryType) String() string {
	return proto1.EnumName(DiscoveryType_name, int32(x))
}
func (x *DiscoveryType) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(DiscoveryType_value, data, "DiscoveryType")
	if err != nil {
		return err
	}
...
func init() {
	...
	proto1.RegisterEnum("proto.DiscoveryType", DiscoveryType_name, DiscoveryType_value)
...
var fileDescriptor2 = []byte{
	...
	,
}
